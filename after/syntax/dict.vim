...
syn match matchesHeader        '^[0-9]\+ \(definition\|definitions\) found' nextgroup=matches
syn match matchesCount        containedin=matchesHeader contained '^[0-9]\+' nextgroup=matchesLabel
syn match matchesLabel    containedin=matchesHeader contained '\(definition\|definitions\) found'
